...
```bash
export POCKETPAW_AGENT_BACKEND="open_interpreter"

# For Ollama (local)
export POCKETPAW_OI_MODEL="ollama/llama3.2"

# For OpenAI
export POCKETPAW_OI_MODEL="gpt-4o"
export POCKETPAW_OPENAI_API_KEY="sk-..."

# For Anthropic
export POCKETPAW_OI_MODEL="claude-sonnet-4-5-20250929"
