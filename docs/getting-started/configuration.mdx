...
export POCKETPAW_AGENT_BACKEND="claude_agent_sdk"  # or pocketpaw_native, open_interpreter
...
export POCKETPAW_LLM_PROVIDER="ollama"             # auto, anthropic, openai, or ollama
