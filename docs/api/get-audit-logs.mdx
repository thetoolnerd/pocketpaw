...
Returns recent entries from the append-only audit log (`~/.pocketpaw/audit.jsonl`). The audit log records tool executions, security events, and Guardian AI decisions.
